...
$string['dbextraexttable'] = 'External database table to get the first bit of extra data from';
$string['dbextraint'] = 'Internal Mahara database field to add 1st extra bit of data to';
$string['dbextraext'] = 'External database field to get the first bit of extra data from';
